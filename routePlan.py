...
print("Entering Route Finding")

route, time = routeFinding.find_route(start, goal_dist, graph) # calls the main DFS function

# Immediately remove the self-loop edge from the route graph if it exists.
if route.has_edge(start, start):
    route.remove_edge(start, start)

print("Passed Route Finding")
...
route_vertices = [sorted_route[0][0]] + [v for u, v in sorted_route]
